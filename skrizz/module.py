# -*- coding: utf-8 -*-
"""This module is meant to be imported from skrizz modules.

It defines the following decorators for defining skrizz callables:
skrizz.module.rule
skrizz.module.thread
skrizz.module.name (deprecated)
skrizz.module.command
skrizz.module.nickname_command
skrizz.module.priority
skrizz.module.event
skrizz.module.rate
skrizz.module.example
"""
"""
skrizz/module.py - Skrizz IRC Bot (http://skrizz.dftba.net/)
...
*Avalability: 4.0+; available as ``Skrizz.NOLIMIT`` in 3.2*
...
def rule(value):
    ...
    If the Skrizz instance is in a channel, or sent a PRIVMSG, where a string
...
def event(value):
    ...
    (More details can be found in RFC 1459.) When the Skrizz bot is sent one of
...
def rate(value):
    ...
    on the admin list in Skrizz’s configuration are exempted from rate limits.
    """
    def add_attribute(function):
        function.rate = value
        return function
