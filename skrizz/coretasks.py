# coding=utf-8
"""
coretasks.py - Skrizz Ruotine Core tasks
...
#Functions to maintain a list of chanops in all of skrizz's channels.


@skrizz.module.command('newoplist')
...
@skrizz.module.command('listvoices')
...
@skrizz.module.command('blocks')
@skrizz.module.priority('low')
@skrizz.module.thread(False)
def blocks(bot, trigger):
    """
    Manage Skrizz's blocking features.
    """
    ...
    STRINGS = {
        ...
        "invalid": "Invalid format for %s a block. Try: .blocks add (nick|hostmask) skrizz",
