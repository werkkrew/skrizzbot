...
import re
from skrizz.module import command, commands, priority
...
def op(bot, trigger):
    ...
    skrizz will op the nick who sent the command
    """
    if trigger.isop:
...
def deop(bot, trigger):
    ...
    skrizz will deop the nick who sent the command
    """
    if trigger.isop:
        nick = trigger.group(2)
        channel = trigger.sender
...
def voice(bot, trigger):
    ...
    skrizz will voice the nick who sent the command
    """
    if trigger.isop:
        nick = trigger.group(2)
        channel = trigger.sender
...
def devoice(bot, trigger):
    ...
    skrizz will devoice the nick who sent the command
    """
    if trigger.isop:
        nick = trigger.group(2)
        channel = trigger.sender
